...
import { credencialesUsuarios } from "./auth.model";
...
interface formularioAuthProps{
    modelo: credencialesUsuarios;
    onSubmit(valores: credencialesUsuarios, acciones: FormikHelpers<credencialesUsuarios>): void;
}